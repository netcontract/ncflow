...
FLEISCHER_RUN_DIR = os.path.abspath(
    os.path.join(TL_DIR, 'ext', 'fleischer'))
...
if __name__ == '__main__':
    ...
    if not os.path.exists(input_dir):
        print('{} does not exist; cannot run benchmark without input files. Run scripts/serialize_all_fleischer.py'.
              format(input_dir))
        exit(1)
