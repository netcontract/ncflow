...
from benchmark_consts import PROBLEM_NAMES, NCFLOW_HYPERPARAMS, PATH_FORM_HYPERPARAMS, print_
...
HEADERS = [
    ...
    'num_commodities', 'total_demand', 'algo', 'clustering_algo',
    'num_partitions', 'partition_runtime', 'num_paths', 'edge_disjoint',
    'dist_metric', 'total_num_fib_entries', 'max_num_fib_entries'
]
...
def get_fib_entry_problem(problem_name):
    ...
    for tm_fname in iglob(
            '../traffic-matrices/full-tms/{}*_traffic-matrix.pkl'.format(
                problem_name)):
